...
public class DHCsvDataLoad : MonoBehaviour
{
    ...
    ///// <summary>인스펙터 할당 참조용. DHCsvTemplateCatalog가 동일 GameObject의 CSV를 폴백으로 읽을 때 사용합니다.</summary>
    //public TextAsset PlayerUnitCsvAsset => playerUnitCsv;

    ///// <summary>인스펙터 할당 참조용. DHCsvTemplateCatalog가 동일 GameObject의 CSV를 폴백으로 읽을 때 사용합니다.</summary>
    //public TextAsset EnemyUnitCsvAsset => enemyUnitCsv;

    ///// <summary>인스펙터 할당 참조용. DHCsvTemplateCatalog가 동일 GameObject의 CSV를 폴백으로 읽을 때 사용합니다.</summary>
    //public TextAsset WeaponSheetCsvAsset => weaponSheetCsv;
