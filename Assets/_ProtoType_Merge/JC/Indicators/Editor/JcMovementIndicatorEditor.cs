...
namespace JC.Indicators.EditorTools
{
    ...
    public sealed class JcMovementIndicatorEditor : Editor
    {
        private static readonly string[][] Groups =
        {
            ...
            new[] { "공통 입체 형태", "commonThickness|공통 입체 두께 (월드)", "bevelWidth|도착 문양 베벨 폭", "curveSegments|곡선 분할 수", "sideBrightness|옆면 밝기" },
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(controller.Profile == null))
            {
                ...
                if (controller.Profile != null)
                    EditorGUILayout.LabelField(JsonUtility.ToJson(controller.Settings) == JsonUtility.ToJson(controller.ResolveSettings(controller.Profile.settings))
