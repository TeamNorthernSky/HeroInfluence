...
namespace JC.VFX
{
    ...
    public class TaoMagicCirclePreset : ScriptableObject
    {
        ...
        [Tooltip("지면 위 띄우는 높이(m). z-fighting 방지")]
        public float groundOffsetY = 0.02f;
        [Tooltip("페이드인 동안 퍼져나오는 정도")]
        ...
        [Tooltip("전체 밝기 펄스 진폭")]
        [Range(0f, 1f)] public float pulseAmp = 0.18f;
        [Tooltip("펄스 빈도(초당)")]
        [Range(0f, 12f)] public float pulseFreq = 2.4f;
        ...
        [Header("중심 광채 / 경계")]
        [Tooltip("중심 부드러운 광채 세기(0=문양만)")]
        [Range(0f, 3f)] public float centerGlow = 0.55f;
        [Tooltip("중심 광채 감쇠 지수(클수록 좁게 모임)")]
        [Range(0.5f, 8f)] public float centerFalloff = 2.6f;
