...
[CreateAssetMenu(fileName="RewardConditionDataTable", menuName="DataTable/RewardCondition")]
public class RewardConditionDataTable : ScriptableObject
{
    public List<RewardConditionData> DataList = new List<RewardConditionData>();
}
