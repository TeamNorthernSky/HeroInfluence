...
[CreateAssetMenu(fileName="EnemyUnitInfoDataTable", menuName="DataTable/EnemyUnitInfo")]
public class EnemyUnitInfoDataTable : ScriptableObject
{
    public List<EnemyUnitInfoData> DataList = new List<EnemyUnitInfoData>();
}
