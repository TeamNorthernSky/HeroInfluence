...
// Template Signature: dict=0|reward_id:Int:Comma|reward_name:String:Comma|money:Int:Comma|medal:Int:Comma|gem:Int:Comma|supply:Int:Comma|EXP:Int:Comma|Rumina_IP:Int:Comma|Rumina_ATK:Int:Comma|Rumina_MaxHP:Int:Comma|Rumina_Heal:Int:Comma|Rumina_DEF:Int:Comma|Justice_IP:Int:Comma|Justice_ATK:Int:Comma|Justice_MaxHP:Int:Comma|Justice_Heal:Int:Comma|Justice_Def:Int:Comma|BlackBullet_IP:Int:Comma|BlackBullet_ATK:Int:Comma|BlackBullet_MaxHP:Int:Comma|BlackBullet_Heal:Int:Comma|BlackBullet_Def:Int:Comma|Nekoming_IP:Int:Comma|Nekoming_ATK:Int:Comma|Nekoming_MaxHP:Int:Comma|Nekoming_Heal:Int:Comma|Nekoming_Def:Int:Comma

using System.Collections.Generic;
using UnityEngine;

[System.Serializable]
public class MainSubEventRewardData
{
...
[CreateAssetMenu(fileName="MainSubEventRewardDataTable", menuName="DataTable/MainSubEventReward")]
public class MainSubEventRewardDataTable : ScriptableObject
{
    public List<MainSubEventRewardData> DataList = new List<MainSubEventRewardData>();
}
