...
//MatcapMask
        ...
        //
        // 별개의 아웃라인을 사용하기 때문에  아웃라인 관련 코드 제거
        // ...할줄 알았지만, CustomEditor 설정때문에 유지중
...
//            #pragma shader_feature _OCCLUSIONMAP
            ...
            // 쉐이더 파일이 에셋폴더에 생겼기 때문에 패키지 폴더부터 들어감
            #include "HLSL/KJ_UniversalToonInput.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/LitForwardPass.hlsl"
            #include "Packages/com.unity.toonshader/Runtime/UniversalRP/Shaders/UniversalToonHead.hlsl"
            #include "HLSL/KJ_UniversalToonBody.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
#endif
            ENDHLSL
